  ...
  return (
    <div className="container mx-auto px-4 sm:px-6 lg:px-8 py-8">
      <div className="text-center mb-12">
        <h1 className="text-6xl md:text-7xl font-headline font-extrabold tracking-tight text-primary dark:drop-shadow-[0_0_10px_hsl(var(--primary))]">CryptoPulse Blog</h1>
